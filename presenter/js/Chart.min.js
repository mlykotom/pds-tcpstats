...
(function () {
    ...
    var s = e.helpers = {}, n = s.each = function (t, i, e) {
        ...
        for (var d = Math.abs(u - c), p = C(d), f = Math.ceil(u / (1 * Math.pow(10, p))) * Math.pow(10, p), v = s ? 0 : Math.floor(c / (1 * Math.pow(10, p))) * Math.pow(10, p), S = f - v, x = Math.pow(10, p), y = Math.round(S / x); (y > h || h > 2 * y) && !l;)if (y > h)x *= 2, y = Math.round(S / x), y % 1 !== 0 && (l = !0); else if (o && p >= 0) {
            if (x / 2 % 1 !== 0)break;
            x /= 2, y = Math.round(S / x)
        } else x /= 2, y = Math.round(S / x);
        return l && (y = a, x = S / y), {steps: y, stepValue: x, min: v, max: v + y * x}
    ...
    e.instances = {}, e.Type = function (t, i, s) {
        ...
        initialize: function () {
            ...
            return s.template(this.options.legendTemplate, {datasets: this.datasets})
        }, destroy: function () {
        ...
        inRange: function (t, i) {
            var e = s.getAngleFromPoint(this, {
                x: t,
                y: i
            }), n = e.angle % (2 * Math.PI), o = (2 * Math.PI + this.startAngle) % (2 * Math.PI), a = (2 * Math.PI + this.endAngle) % (2 * Math.PI) || 360, h = o > a ? a >= n || n >= o : n >= o && a >= n, l = e.distance >= this.innerRadius && e.distance <= this.outerRadius;
            return h && l
        }, tooltipPosition: function () {
                ...
                if (n(this.yLabels, function (i, e) {
                    ...
                    for (var i = this.valuesCount - 1; i >= 0; i--) {
                        ...
                        if (this.angleLineWidth > 0 && (e = this.calculateCenterOffset(this.max), s = this.getPointPosition(i, e), t.beginPath(), t.moveTo(this.xCenter, this.yCenter), t.lineTo(s.x, s.y), t.stroke(), t.closePath()), this.backgroundColors && this.backgroundColors.length == this.valuesCount) {
                            ...
                            var o = this.getPointPosition(0 === i ? this.valuesCount - 1 : i - 1, e), a = this.getPointPosition(i === this.valuesCount - 1 ? 0 : i + 1, e), h = {
                                x: (o.x + s.x) / 2,
                                y: (o.y + s.y) / 2
            ...
            this.ScaleClass = i.Scale.extend({
                ...
                this.datasets.push(n), e.each(i.data, function (e, s) {
                    n.bars.push(new this.BarClass({
                        ...
                        strokeColor: "string" != typeof i.strokeColor ? i.strokeColor[s] : i.strokeColor,
                        fillColor: "string" != typeof i.fillColor ? i.fillColor[s] : i.fillColor,
                        highlightFill: i.highlightFill && "string" != typeof i.highlightFill ? i.highlightFill[s] || i.highlightFill : "string" != typeof i.fillColor ? i.fillColor[s] : i.fillColor,
                        highlightStroke: i.highlightStroke && "string" != typeof i.highlightStroke ? i.highlightStroke[s] || i.highlightStroke : "string" != typeof i.strokeColor ? i.strokeColor[s] : i.strokeColor
                    }))
                }, this)
